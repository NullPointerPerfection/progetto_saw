...
<div class="incima">
    ...
    <div>
        <ul class="ulgin">
            <li class="opulence"><a href="home.php" id="home" class="rad"><span class="uno">H</span>ome</a></li>
            <li class="opulence"><a href="compra.php" id="compra" class="rad"><span class="uno">C</span>ompra</a></li>
            <li class="opulence mdx"><a href="chisiamo.php" id="chisiamo" class="rad"><span class="uno">C</span>hi <span class="uno">S</span>iamo</a></li>
...
<div class="hidfix" id="pink">
    <div class="bbk">
        ...
        <form method="post" id="login">
            ...
            <button class="bolo" id="invio" type="submit">Accedi</button>
        </form>
